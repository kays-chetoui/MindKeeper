...
function App() {
	...
	const navigation = [
		{ name: t("navigation.tasks"), href: "#" },
		{ name: t("navigation.budget"), href: "#" },
		{ name: t("navigation.profile"), href: "#" },
		{ name: t("navigation.company"), href: "#" },
	];
				...
				<div className="relative isolate px-6 pt-14 lg:px-8">
					...
					<div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
						<div className="hidden sm:mb-8 sm:flex sm:justify-center">
							<div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">{t("hero.announcement")}</div>
						</div>
						<div className="text-center">
							<h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">{t("hero.title")}</h1>
							<p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">{t("hero.subtitle")}</p>
							<div className="mt-10 flex items-center justify-center gap-x-6">
								...
								<a href="#" className="text-sm/6 font-semibold text-gray-900">
									{t("hero.seeHowItWorks")} <span aria-hidden="true">→</span>
								</a>
							</div>
						</div>
					</div>
